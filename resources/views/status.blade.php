...
<head>
    ...
    <script defer="defer"
            src="https://gu-st.ru/covid-web-st/static-pages-assets/covid-check/index.34e1bc87ac8239ed2688.min.js"></script>
    <link href="https://gu-st.ru/covid-web-st/static-pages-assets/covid-check/index.109379b131aa303bb1ba.min.css"
          rel="stylesheet">
</head>
<body>
...
<div id="result" class="vaccine-result">
    <div class="flex-container ml-6 mr-6 justify-between align-items-center mt-52 mb-32">
        ...
        <div id="translate-button" class="translate-button flex-container mt-6 mr-24 align-items-center">
            ...
            <div id="lang-label" class="lang"></div>
        </div>
    </div>
    <div>
        <div class="status-container mt-28">
            ...
            <div class="status-container-inner"><h4 id="main-title" class="title-h4 white status-title main-title">
                    Сертификат COVID-19</h4>
                <div class="status mt-12 text-plain small-text bold"><span id="status"
                                                                           class="status-value cert-name">Действителен</span>
                </div>
                <h4 id="cert-id-block" class="title-h4 white status-title mt-12"><span class="num-symbol">№</span> <span
                        class="unrz" id="cert-id"> {{$certificate->cert_number}}</span></h4></div>
        </div>
        <div id="dates-block" class="person-data person-data-dates mt-12">
            <div class="mb-4 person-data-wrap align-items-center">
                ...
                <div id="dates" class="small-text gray mr-4">Действует до {{Carbon\Carbon::parse($certificate->drug_creation_date)->addMonths(12)}}</div>
            </div>
        </div>
            ...
            <div id="other-attrs">
                <div id="other-attrs">
                    <div class="mb-4 person-data-wrap attr-wrap">
                        ...
                        <div class="attr-value small-text gray">{{$certificate->birthday}}</div>
                    </div>
                    <div class="mb-4 person-data-wrap attr-wrap">
                        <div class="small-text mb-4 mr-4 attr-title">Паспорт:</div>
                        <div class="attr-value small-text gray">{{$certificate->prepared_passport}}</div>
                    </div>
                </div>
            </div>
        </div>
